...
namespace WebAPISite.Controllers
{
    ...
    public class AccountController : ApiController
    {
        ...
        public async Task<IHttpActionResult> Login(LoginViewModel model)
        {
           ...
           // var userToRegister = db.GetUserAccess(model.Email).Count();
           ...
           // }
            ...
            if (user != null)
            {
                ...
                switch (result)
                {
                    case SignInStatus.Success:
                        this.UserManager.RemoveFromRole(user.Id, "TwoFactorVerified");
                        return Ok(user);
                    case SignInStatus.LockedOut:
                        return BadRequest("Username is locked. Please contact Administrator");
                    case SignInStatus.RequiresVerification:
                        this.UserManager.RemoveFromRole(user.Id, "TwoFactorVerified");
                        return Ok(user); //RedirectToAction("SendCode", new { ReturnUrl = returnUrl, false });
            ...
            {
                return BadRequest("You are not authorized user to login. Please contact administrator");
                //turn BadRequest("Invalid login attempt.");
            }
