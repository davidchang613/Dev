var Customers = function () {
    ...
    self.changeRange = function () {
        var newYear = Globalize.formatDate(new Date(self.startDate), { raw: "yyyy" });
    ...
    self.init = function () {
        ...
        SaleViewer.sharedWidgets.initRange(function(e) {
            ...
            var newStartDate = Globalize.formatDate(e.startValue, { raw: "yyyy-MM-dd" }),
                newEndDate = Globalize.formatDate(e.endValue, { raw: "yyyy-MM-dd" });
