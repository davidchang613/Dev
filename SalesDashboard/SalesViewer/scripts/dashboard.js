var Dashboard = function (category) {
    ...
    self.startDate = Globalize.formatDate(getCurrentDate(), { raw: "yyyy-01-01" });
    self.endDate = Globalize.formatDate(getCurrentDate(), { raw: "yyyy-12-30" });
    yearContainer.text(Globalize.formatDate(getCurrentDate(), { raw: "yyyy" }));
    ...
    self.init = function() {
        ...
        SaleViewer.sharedWidgets.initRange(function(e) {
            ...
            var startDate = Globalize.formatDate(e.startValue, { raw: "yyyy-MM-dd" }),
                endDate = Globalize.formatDate(e.endValue, { raw: "yyyy-MM-dd" });
            ...
            if(self.startDate != startDate || self.endDate != endDate || first) {
                ...
                yearContainer.text(Globalize.formatDate(e.startValue, { raw: "yyyy" }));
